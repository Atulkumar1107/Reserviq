      ...
      {rooms.map((room, i) => (
        ...
        >
          ...
          <Link
            ...
            className="mt-auto bg-[#FAF9F6] text-[#1E293B] border-2 border-[#1E293B] px-6 py-3 rounded-2xl hover:bg-[#1E293B] hover:text-white transition-all font-black uppercase tracking-widest text-xs text-center"
          >
            View &amp; Book
          </Link>
        </motion.div>
              ...
              >
                <div className="grid md:grid-cols-2 gap-12 p-8 lg:p-16">
                  ...
                  <div>
                    ...
                    {/* Gallery thumbs */}
                    {featuredRoom.gallery?.length > 1 && (
                      <div className="grid grid-cols-3 gap-3">
                        {featuredRoom.gallery.slice(1).map((src, i) => (
